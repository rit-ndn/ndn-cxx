...
sleep ${sleep}; ssh ${username}@${rPi3WiFiIP} "nfdc face create remote ether://[${jetsonNanoETHMAC}] local dev://${rPi3ETHinterface} persistency permanent >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${jetsonNanoETHIP} "nfdc face create remote ether://[${rPi3ETHMAC}] local dev://${jetsonNanoETHinterface} persistency permanent >/dev/null 2>&1 &"
...
sleep ${sleep}; ssh ${username}@${jetsonNanoETHIP} "nfdc route add /interCACHE ether://[${jetsonNanoETHMAC}] >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${jetsonNanoETHIP} "nfdc route add /interCACHE/service1 ether://[${rPi3ETHMAC}] >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${jetsonNanoETHIP} "nfdc route add /interCACHE/service3 ether://[${rPi3ETHMAC}] >/dev/null 2>&1 &"
