...
sleep ${sleep}; ssh ${username}@${rPi3WiFiIP} "nfdc face create remote ether://[${jetsonETHMAC}] local dev://${rPi3ETHinterface} persistency permanent >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${jetsonETHIP} "nfdc face create remote ether://[${rPi3ETHMAC}] local dev://${jetsonETHinterface} persistency permanent >/dev/null 2>&1 &"
...
sleep ${sleep}; ssh ${username}@${rPi3WiFiIP} "nfdc route add /interCACHE/sensor ether://[${jetsonETHMAC}] >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rPi3WiFiIP} "nfdc route add /interCACHE/service2 ether://[${jetsonETHMAC}] >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rPi3WiFiIP} "nfdc route add /interCACHE/service4 ether://[${jetsonETHMAC}] >/dev/null 2>&1 &"

sleep ${sleep}; ssh ${username}@${jetsonETHIP} "nfdc route add /interCACHE ether://[${jetsonETHMAC}] >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${jetsonETHIP} "nfdc route add /interCACHE/service1 ether://[${rPi3ETHMAC}] >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${jetsonETHIP} "nfdc route add /interCACHE/service3 ether://[${rPi3ETHMAC}] >/dev/null 2>&1 &"
