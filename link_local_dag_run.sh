...
ssh ${username}@${jetsonNanoUSBETHIP} "nfd-start >/dev/null 2>&1 &"
...
sleep ${sleep}; ssh ${username}@${rPi3WiFiIP} "nfdc face create remote ether://[${jetsonNanoETHMAC}] local dev://${rPi3USBETHinterface} persistency permanent >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${jetsonNanoUSBETHIP} "nfdc face create remote ether://[${rPi3USBETHMAC}] local dev://${jetsonNanoETHinterface} persistency permanent >/dev/null 2>&1 &"
...
sleep ${sleep}; ssh ${username}@${rPi3WiFiIP} "nfdc route add /interCACHE/sensor ether://[${jetsonNanoETHMAC}] >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rPi3WiFiIP} "nfdc route add /interCACHE/service2 ether://[${jetsonNanoETHMAC}] >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rPi3WiFiIP} "nfdc route add /interCACHE/service4 ether://[${jetsonNanoETHMAC}] >/dev/null 2>&1 &"

sleep ${sleep}; ssh ${username}@${jetsonNanoUSBETHIP} "nfdc route add /interCACHE ether://[${jetsonNanoETHMAC}] >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${jetsonNanoUSBETHIP} "nfdc route add /interCACHE/service1 ether://[${rPi3USBETHMAC}] >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${jetsonNanoUSBETHIP} "nfdc route add /interCACHE/service3 ether://[${rPi3USBETHMAC}] >/dev/null 2>&1 &"
...
# 4 DAG - interCACHE Forwarder
# start producer application
sleep ${sleep}; ssh ${username}@${jetsonNanoUSBETHIP} "~/ndn/ndn-cxx/build/examples/cabeee-custom-app-producer /interCACHE /sensor >/dev/null 2>&1 &"
# start forwarder application(s)
sleep ${sleep}; ssh ${username}@${rPi3WiFiIP} "~/ndn/ndn-cxx/build/examples/cabeee-dag-forwarder-app /interCACHE /service1 >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${jetsonNanoUSBETHIP} "~/ndn/ndn-cxx/build/examples/cabeee-dag-forwarder-app /interCACHE /service2 >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rPi3WiFiIP} "~/ndn/ndn-cxx/build/examples/cabeee-dag-forwarder-app /interCACHE /service3 >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${jetsonNanoUSBETHIP} "~/ndn/ndn-cxx/build/examples/cabeee-dag-forwarder-app /interCACHE /service4 >/dev/null 2>&1 &"
...
ssh ${username}@${jetsonNanoUSBETHIP} "nfd-stop >/dev/null 2>&1 &"
