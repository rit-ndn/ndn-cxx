...
#ssh cabeee@192.168.20.143 'nohup nfd-start >/dev/null 2>/dev/null </dev/null &'
...
#ssh cabeee@192.168.20.143 'nfd-start >/dev/null 2>&1 &'
#ssh cabeee@192.168.20.151 'nfd-start >/dev/null 2>&1 &'
#ssh cabeee@192.168.20.147 'nfd-start >/dev/null 2>&1 &'

# create the faces
sleep 1; ssh cabeee@192.168.20.143 'nfdc face create remote ether://[d8:3a:dd:2e:c5:1f] local dev://eno1 persistency permanent >/dev/null 2>&1 &'
sleep 1; ssh cabeee@192.168.20.147 'nfdc face create remote ether://[D8:CB:8A:BC:A3:94] local dev://eth0 persistency permanent >/dev/null 2>&1 &'


# add routes for all the PREFIXes to all nodes
sleep 1; ssh cabeee@192.168.20.143 'nfdc route add /interCACHE ether://[d8:3a:dd:2e:c5:1f] >/dev/null 2>&1 &'
sleep 1; ssh cabeee@192.168.20.147 'nfdc route add /interCACHE ether://[d8:3a:dd:2e:c5:1f] >/dev/null 2>&1 &'

#sleep 1; ssh cabeee@192.168.20.143 'nfdc route add /interCACHE/sensor udp://192.168.20.147 >/dev/null 2>&1 &'
#sleep 1; ssh cabeee@192.168.20.143 'nfdc route add /interCACHE/service1 udp://192.168.20.147 >/dev/null 2>&1 &'
#sleep 1; ssh cabeee@192.168.20.143 'nfdc route add /interCACHE/service2 udp://192.168.20.147 >/dev/null 2>&1 &'
#sleep 1; ssh cabeee@192.168.20.143 'nfdc route add /interCACHE/service3 udp://192.168.20.147 >/dev/null 2>&1 &'
#sleep 1; ssh cabeee@192.168.20.143 'nfdc route add /interCACHE/service4 udp://192.168.20.147 >/dev/null 2>&1 &'
...
#sleep 1; ssh cabeee@192.168.20.143 'nfdc route add /interCACHE/sensor udp://192.168.20.151 >/dev/null 2>&1 &'
#sleep 1; ssh cabeee@192.168.20.143 'nfdc route add /interCACHE/service1 udp://192.168.20.147 >/dev/null 2>&1 &'
#sleep 1; ssh cabeee@192.168.20.143 'nfdc route add /interCACHE/service2 udp://192.168.20.151 >/dev/null 2>&1 &'
#sleep 1; ssh cabeee@192.168.20.143 'nfdc route add /interCACHE/service3 udp://192.168.20.147 >/dev/null 2>&1 &'
#sleep 1; ssh cabeee@192.168.20.143 'nfdc route add /interCACHE/service4 udp://192.168.20.147 >/dev/null 2>&1 &'
