...
# create the faces
sleep ${sleep}; ssh ${username}@${rPi4WiFiIP} "nfdc face create remote ether://[${rtr3ETHMAC}] local dev://${rPi4ETHinterface} persistency permanent >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr3WiFiIP} "nfdc face create remote ether://[${rPi4ETHMAC}] local dev://${rtr3ETHinterface} persistency permanent >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr3WiFiIP} "nfdc face create remote ether://[${rtr2ETHMAC}] local dev://${rtr3USBETHinterface} persistency permanent >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr2WiFiIP} "nfdc face create remote ether://[${rtr3USBETHMAC}] local dev://${rtr2ETHinterface} persistency permanent >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr2WiFiIP} "nfdc face create remote ether://[${rtr1ETHMAC}] local dev://${rtr2USBETHinterface} persistency permanent >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr1WiFiIP} "nfdc face create remote ether://[${rtr2USBETHMAC}] local dev://${rtr1ETHinterface} persistency permanent >/dev/null 2>&1 &"
...
sleep ${sleep}; ssh ${username}@${rPi4WiFiIP} "nfdc route add /interCACHE ether://[${rtr3ETHMAC}] >/dev/null 2>&1 &"
...
sleep ${sleep}; ssh ${username}@${rtr2WiFiIP} "nfdc route add /interCACHE/service1 ether://[${rtr3USBETHMAC}] >/dev/null 2>&1 &"
...
sleep ${sleep}; ssh ${username}@${rtr1WiFiIP} "nfdc route add /interCACHE/service1 ether://[${rtr2USBETHMAC}] >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr1WiFiIP} "nfdc route add /interCACHE/service3 ether://[${rtr2USBETHMAC}] >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr1WiFiIP} "nfdc route add /interCACHE/service4 ether://[${rtr2USBETHMAC}] >/dev/null 2>&1 &"

sleep ${sleep}; ssh ${username}@${jetsonETHIP} "nfdc route add /interCACHE ether://[${jetsonUSBETHMAC}] >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${jetsonETHIP} "nfdc route add /interCACHE/service1 ether://[${rtr1ETHMAC}] >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${jetsonETHIP} "nfdc route add /interCACHE/service2 ether://[${rtr1ETHMAC}] >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${jetsonETHIP} "nfdc route add /interCACHE/service3 ether://[${rtr1ETHMAC}] >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${jetsonETHIP} "nfdc route add /interCACHE/service4 ether://[${rtr1ETHMAC}] >/dev/null 2>&1 &"
