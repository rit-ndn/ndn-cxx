...
scp ~/ndn/ndn-cxx/run_scripts/*.sh ${username}@${producerWiFiIP}:~/ndn/ndn-cxx/run_scripts/
scp ~/ndn/ndn-cxx/run_scripts/*.sh ${username}@${rtr1WiFiIP}:~/ndn/ndn-cxx/run_scripts/
scp ~/ndn/ndn-cxx/run_scripts/*.sh ${username}@${rtr2WiFiIP}:~/ndn/ndn-cxx/run_scripts/
scp ~/ndn/ndn-cxx/run_scripts/*.sh ${username}@${rtr3WiFiIP}:~/ndn/ndn-cxx/run_scripts/
