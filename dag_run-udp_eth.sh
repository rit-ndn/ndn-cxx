...
# create the faces
sleep ${sleep}; ssh ${username}@${rPi4WiFiIP} "nfdc face create remote udp://${rtr3ETHIP} >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr3WiFiIP} "nfdc face create remote udp://${rPi4ETHIP} >/dev/null 2>&1 &"
...
sleep ${sleep}; ssh ${username}@${jetsonETHIP} "nfdc face create remote udp://${rtr1ETHIP} >/dev/null 2>&1 &"


# add routes for all the PREFIXes to all nodes
sleep ${sleep}; ssh ${username}@${rPi4WiFiIP} "nfdc route add /interCACHE udp://${rtr3ETHIP} >/dev/null 2>&1 &"
...
sleep ${sleep}; ssh ${username}@${jetsonETHIP} "nfdc route add /interCACHE/service1 udp://${rtr1ETHIP} >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${jetsonETHIP} "nfdc route add /interCACHE/service2 udp://${rtr1ETHIP} >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${jetsonETHIP} "nfdc route add /interCACHE/service3 udp://${rtr1ETHIP} >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${jetsonETHIP} "nfdc route add /interCACHE/service4 udp://${rtr1ETHIP} >/dev/null 2>&1 &"
