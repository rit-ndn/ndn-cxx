...
# create the faces
sleep ${sleep}; ssh ${username}@${consumerWiFiIP} "nfdc face create remote ether://[${rtr3WiFiMAC}] local dev://${consumerWiFiinterface} persistency permanent >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr3WiFiIP} "nfdc face create remote ether://[${consumerWiFiMAC}] local dev://${rtr3WiFiinterface} persistency permanent >/dev/null 2>&1 &"
...
sleep ${sleep}; ssh ${username}@${rtr1WiFiIP} "nfdc face create remote ether://[${producerWiFiMAC}] local dev://${rtr1WiFiinterface} persistency permanent >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${producerWiFiIP} "nfdc face create remote ether://[${rtr1WiFiMAC}] local dev://${producerWiFiinterface} persistency permanent >/dev/null 2>&1 &"


# add routes for all the PREFIXes to all nodes
sleep ${sleep}; ssh ${username}@${consumerWiFiIP} "nfdc route add /interCACHE ether://[${rtr3WiFiMAC}] >/dev/null 2>&1 &"
...
sleep ${sleep}; ssh ${username}@${rtr1WiFiIP} "nfdc route add /interCACHE/sensor ether://[${producerWiFiMAC}] >/dev/null 2>&1 &"
...
sleep ${sleep}; ssh ${username}@${producerWiFiIP} "nfdc route add /interCACHE ether://[${producerWiFiMAC}] >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${producerWiFiIP} "nfdc route add /interCACHE/service1 ether://[${rtr1WiFiMAC}] >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${producerWiFiIP} "nfdc route add /interCACHE/service2 ether://[${rtr1WiFiMAC}] >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${producerWiFiIP} "nfdc route add /interCACHE/service3 ether://[${rtr1WiFiMAC}] >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${producerWiFiIP} "nfdc route add /interCACHE/service4 ether://[${rtr1WiFiMAC}] >/dev/null 2>&1 &"
