...
# create the faces
sleep ${sleep}; ssh ${username}@${rPi4WiFiIP} "nfdc face create remote ether://[${rtr3WiFiMAC}] local dev://${rPi4WiFiinterface} persistency permanent >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr3WiFiIP} "nfdc face create remote ether://[${rPi4WiFiMAC}] local dev://${rtr3WiFiinterface} persistency permanent >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr3WiFiIP} "nfdc face create remote ether://[${rtr2WiFiMAC}] local dev://${rtr3WiFiinterface} persistency permanent >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr2WiFiIP} "nfdc face create remote ether://[${rtr3WiFiMAC}] local dev://${rtr2WiFiinterface} persistency permanent >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr2WiFiIP} "nfdc face create remote ether://[${rtr1WiFiMAC}] local dev://${rtr2WiFiinterface} persistency permanent >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr1WiFiIP} "nfdc face create remote ether://[${rtr2WiFiMAC}] local dev://${rtr1WiFiinterface} persistency permanent >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr1WiFiIP} "nfdc face create remote ether://[${jetsonETHMAC}] local dev://${rtr1WiFiinterface} persistency permanent >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${jetsonETHIP} "nfdc face create remote ether://[${rtr1WiFiMAC}] local dev://${jetsonETHinterface} persistency permanent >/dev/null 2>&1 &"


# add routes for all the PREFIXes to all nodes
sleep ${sleep}; ssh ${username}@${rPi4WiFiIP} "nfdc route add /interCACHE ether://[${rtr3WiFiMAC}] >/dev/null 2>&1 &"

sleep ${sleep}; ssh ${username}@${rtr3WiFiIP} "nfdc route add /interCACHE ether://[${rtr3WiFiMAC}] >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr3WiFiIP} "nfdc route add /interCACHE/sensor ether://[${rtr2WiFiMAC}] >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr3WiFiIP} "nfdc route add /interCACHE/service2 ether://[${rtr2WiFiMAC}] >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr3WiFiIP} "nfdc route add /interCACHE/service3 ether://[${rtr2WiFiMAC}] >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr3WiFiIP} "nfdc route add /interCACHE/service4 ether://[${rtr2WiFiMAC}] >/dev/null 2>&1 &"

sleep ${sleep}; ssh ${username}@${rtr2WiFiIP} "nfdc route add /interCACHE ether://[${rtr2WiFiMAC}] >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr2WiFiIP} "nfdc route add /interCACHE/sensor ether://[${rtr1WiFiMAC}] >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr2WiFiIP} "nfdc route add /interCACHE/service2 ether://[${rtr1WiFiMAC}] >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr2WiFiIP} "nfdc route add /interCACHE/service1 ether://[${rtr3WiFiMAC}] >/dev/null 2>&1 &"

sleep ${sleep}; ssh ${username}@${rtr1WiFiIP} "nfdc route add /interCACHE ether://[${rtr1WiFiMAC}] >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr1WiFiIP} "nfdc route add /interCACHE/sensor ether://[${jetsonETHMAC}] >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr1WiFiIP} "nfdc route add /interCACHE/service1 ether://[${rtr2WiFiMAC}] >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr1WiFiIP} "nfdc route add /interCACHE/service3 ether://[${rtr2WiFiMAC}] >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr1WiFiIP} "nfdc route add /interCACHE/service4 ether://[${rtr2WiFiMAC}] >/dev/null 2>&1 &"

sleep ${sleep}; ssh ${username}@${jetsonETHIP} "nfdc route add /interCACHE ether://[${jetsonETHMAC}] >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${jetsonETHIP} "nfdc route add /interCACHE/service1 ether://[${rtr1WiFiMAC}] >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${jetsonETHIP} "nfdc route add /interCACHE/service2 ether://[${rtr1WiFiMAC}] >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${jetsonETHIP} "nfdc route add /interCACHE/service3 ether://[${rtr1WiFiMAC}] >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${jetsonETHIP} "nfdc route add /interCACHE/service4 ether://[${rtr1WiFiMAC}] >/dev/null 2>&1 &"
