...
sleep ${sleep}; ssh ${username}@${consumerWiFiIP} "sudo nlsr -f ~/ndn/NLSR/nlsr-consumer.conf >/dev/null 2>&1 &"
...
sleep ${sleep}; ssh ${username}@${producerWiFiIP} "sudo nlsr -f ~/ndn/NLSR/nlsr-producer.conf >/dev/null 2>&1 &"
