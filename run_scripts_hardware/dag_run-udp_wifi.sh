...
# create the faces
sleep ${sleep}; ssh ${username}@${consumerWiFiIP} "nfdc face create remote udp://${rtr3WiFiIP} >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr3WiFiIP} "nfdc face create remote udp://${consumerWiFiIP} >/dev/null 2>&1 &"
...
sleep ${sleep}; ssh ${username}@${rtr1WiFiIP} "nfdc face create remote udp://${consumerWiFiIP} >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${consumerWiFiIP} "nfdc face create remote udp://${rtr1WiFiIP} >/dev/null 2>&1 &"


# add routes for all the PREFIXes to all nodes
sleep ${sleep}; ssh ${username}@${consumerWiFiIP} "nfdc route add /interCACHE udp://${rtr3WiFiIP} >/dev/null 2>&1 &"
...
sleep ${sleep}; ssh ${username}@${rtr1WiFiIP} "nfdc route add /interCACHE/sensor udp://${consumerWiFiIP} >/dev/null 2>&1 &"
...
sleep ${sleep}; ssh ${username}@${consumerWiFiIP} "nfdc route add /interCACHE udp://${consumerWiFiIP} >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${consumerWiFiIP} "nfdc route add /interCACHE/service1 udp://${rtr1WiFiIP} >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${consumerWiFiIP} "nfdc route add /interCACHE/service2 udp://${rtr1WiFiIP} >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${consumerWiFiIP} "nfdc route add /interCACHE/service3 udp://${rtr1WiFiIP} >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${consumerWiFiIP} "nfdc route add /interCACHE/service4 udp://${rtr1WiFiIP} >/dev/null 2>&1 &"

# 4 DAG - Orchestrator A
# start producer application
#sleep ${sleep}; ssh ${username}@${consumerWiFiIP} "~/ndn/ndn-cxx/build/examples/cabeee-custom-app-producer /interCACHE /sensor >/dev/null 2>&1 &"
