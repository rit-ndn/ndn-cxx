...
# create the faces
sleep ${sleep}; ssh ${username}@${consumerWiFiIP} "nfdc face create remote udp://${rtr3ETHIP} >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr3WiFiIP} "nfdc face create remote udp://${consumerETHIP} >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr3WiFiIP} "nfdc face create remote udp://${rtr2ETHIP} >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr2WiFiIP} "nfdc face create remote udp://${rtr3ETHIP} >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr2WiFiIP} "nfdc face create remote udp://${rtr1ETHIP} >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr1WiFiIP} "nfdc face create remote udp://${rtr2ETHIP} >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr1WiFiIP} "nfdc face create remote udp://${producerETHIP} >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${producerWiFiIP} "nfdc face create remote udp://${rtr1ETHIP} >/dev/null 2>&1 &"


# add routes for all the PREFIXes to all nodes
sleep ${sleep}; ssh ${username}@${consumerWiFiIP} "nfdc route add /interCACHE udp://${rtr3ETHIP} >/dev/null 2>&1 &"

sleep ${sleep}; ssh ${username}@${rtr3WiFiIP} "nfdc route add /interCACHE udp://${rtr3ETHIP} >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr3WiFiIP} "nfdc route add /interCACHE/sensor udp://${rtr2ETHIP} >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr3WiFiIP} "nfdc route add /interCACHE/service2 udp://${rtr2ETHIP} >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr3WiFiIP} "nfdc route add /interCACHE/service3 udp://${rtr2ETHIP} >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr3WiFiIP} "nfdc route add /interCACHE/service4 udp://${rtr2ETHIP} >/dev/null 2>&1 &"

sleep ${sleep}; ssh ${username}@${rtr2WiFiIP} "nfdc route add /interCACHE udp://${rtr2ETHIP} >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr2WiFiIP} "nfdc route add /interCACHE/sensor udp://${rtr1ETHIP} >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr2WiFiIP} "nfdc route add /interCACHE/service2 udp://${rtr1ETHIP} >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr2WiFiIP} "nfdc route add /interCACHE/service1 udp://${rtr3ETHIP} >/dev/null 2>&1 &"

sleep ${sleep}; ssh ${username}@${rtr1WiFiIP} "nfdc route add /interCACHE udp://${rtr1ETHIP} >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr1WiFiIP} "nfdc route add /interCACHE/sensor udp://${producerETHIP} >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr1WiFiIP} "nfdc route add /interCACHE/service1 udp://${rtr2ETHIP} >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr1WiFiIP} "nfdc route add /interCACHE/service3 udp://${rtr2ETHIP} >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${rtr1WiFiIP} "nfdc route add /interCACHE/service4 udp://${rtr2ETHIP} >/dev/null 2>&1 &"

sleep ${sleep}; ssh ${username}@${producerWiFiIP} "nfdc route add /interCACHE udp://${producerETHIP} >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${producerWiFiIP} "nfdc route add /interCACHE/service1 udp://${rtr1ETHIP} >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${producerWiFiIP} "nfdc route add /interCACHE/service2 udp://${rtr1ETHIP} >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${producerWiFiIP} "nfdc route add /interCACHE/service3 udp://${rtr1ETHIP} >/dev/null 2>&1 &"
sleep ${sleep}; ssh ${username}@${producerWiFiIP} "nfdc route add /interCACHE/service4 udp://${rtr1ETHIP} >/dev/null 2>&1 &"
